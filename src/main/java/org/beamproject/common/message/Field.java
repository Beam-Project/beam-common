...
public enum Field {
    ...
    public enum Cnt {
         ...
         * <p>
         * {@code HS_MQTTID} stands for "Handshake MQTT identification" and
         * contains the MQTT <i>username</i> (so called in the MQTT world) that
         * was used by the client to subscribe to the server's MQTT broker.
         * <p>
         * This MQTT username/id is generated randomly by the user's client and
         * is just in the scope of MQTT relevant. This does nothing have to do
         * with the username of the person behind this client.
         * <p>
         * <b>Usage:</b> as key of a key/value pair, nested in
         * {@link Field#CNT}.
         */
         ...
         * allows to establish a long-time session.
         * <p>
         * {@code HS_NONCE} stands for "Handshake Nonce" and contains the nonce,
